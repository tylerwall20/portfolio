      ...
      <section id="projects">
        ...
        <div className="projects-grid">
          ...
          <div className="project-card">
            ...
            <p>
              Unity-based training system built for military personnel. Includes
              VR device authentication, secured access to training materials, and
              multi-scenario modular architecture.
            </p>
      ...
      <section id="contact">
        <div className="contact-inner">
          ...
          <div className="contact-links">
            ...
            <a href="/Tyler_Wallace_Resume.pdf" className="contact-link">
              <svg className="contact-link-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
